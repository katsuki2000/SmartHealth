...
var AppointmentService = function () {
    ...
    var AppointmentService = _classThis = /** @class */ (function () {
        function AppointmentService_1(prisma, eventEmitter) {
            this.prisma = prisma;
            this.eventEmitter = eventEmitter;
            this.logger = new common_1.Logger(AppointmentService.name);
        }
        AppointmentService_1.prototype.create = function (data) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.eventEmitter.emitAppointmentScheduled(newAppointment).catch(function () { });
                            return [2 /*return*/, newAppointment];
                    }
                });
            });
        };
        AppointmentService_1.prototype.findAll = function (userId, role) {
            return __awaiter(this, void 0, void 0, function () {
                var practitioner;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AppointmentService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var appointment;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            appointment = _a.sent();
                            if (!appointment) {
                                throw new common_1.NotFoundException("Appointment with ID ".concat(id, " not found"));
                            }
        ...
        AppointmentService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AppointmentService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.prisma.appointment.delete({
                                    where: { id: id },
                                })];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:

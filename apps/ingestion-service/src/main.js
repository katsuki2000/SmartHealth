...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, corsOrigin, config, document, port;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    app = _b.sent();
                    corsOrigin = (process.env.CORS_ORIGIN || 'http://localhost:3000,http://localhost:4200,http://localhost:5173,http://localhost:5000,http://localhost:5001,http://localhost:5002').split(',');
                    app.enableCors({
                        origin: corsOrigin.map(function (o) { return o.trim(); }),
                        credentials: true,
                ...
                case 2:
                    ...
                    logger.log("\uD83D\uDCDA API Documentation available at: http://localhost:".concat(port, "/api/docs"));
                    return [2 /*return*/];
            }
        });
    });

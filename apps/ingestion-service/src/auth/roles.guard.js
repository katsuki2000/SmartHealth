    ...
    var RolesGuard = _classThis = /** @class */ (function () {
        ...
        RolesGuard_1.prototype.canActivate = function (context) {
            ...
            if (!user || !requiredRoles.includes(user.role)) {
                throw new common_1.ForbiddenException("Acc\u00E8s refus\u00E9. R\u00F4le requis : ".concat(requiredRoles.join(' ou '), ". ") +
                    "Votre r\u00F4le : ".concat((user === null || user === void 0 ? void 0 : user.role) || 'aucun', "."));
            }
            return true;
        };
        return RolesGuard_1;

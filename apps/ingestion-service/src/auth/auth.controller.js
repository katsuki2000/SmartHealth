...
var AuthController = function () {
    ...
    (function () {
        ...
        _register_decorators = [(0, swagger_1.ApiOperation)({
                ...
                description: 'Route protégée : nécessite un token JWT avec le rôle ADMIN. ' +
                    'Utilisez le script "pnpm run seed" pour créer le premier administrateur.',
            }), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN'), (0, common_1.Post)('register')];
        _login_decorators = [(0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Se connecter et obtenir un Token JWT' }), (0, common_1.Post)('login')];

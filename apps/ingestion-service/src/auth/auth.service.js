    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, salt, hashedPassword, userRole, user, password, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            existing = _a.sent();
                            if (existing) {
                                throw new common_1.ConflictException("Un compte avec l'email \"".concat(data.email, "\" existe d\u00E9j\u00E0."));
                            }
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, this.prisma.practitioner.create({
                                    data: {
                                        userId: user.id,

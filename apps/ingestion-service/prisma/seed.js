...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var adminEmail, adminPassword, existing, salt, hashedPassword, admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    existing = _a.sent();
                    if (existing) {
                        console.log("\n\u26A0\uFE0F  L'admin \"".concat(adminEmail, "\" existe d\u00E9j\u00E0 en base."));
                        console.log("   R\u00F4le : ".concat(existing.role));
                        console.log("   ID   : ".concat(existing.id, "\n"));
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, bcrypt.genSalt(10)];
                case 2:
                    salt = _a.sent();
                    return [4 /*yield*/, bcrypt.hash(adminPassword, salt)];
                case 3:
                ...
                case 4:
                    ...
                    console.log("   R\u00F4le     : ".concat(admin.role));
                    console.log("   ID       : ".concat(admin.id));
                    console.log('────────────────────────────────────────');
